...
<body id="body">
    ...
    <div>
        <button class="bouton" id="suivant" disabled onclick="location='<?php echo e(route('getSalle')); ?>'">Suivant</button>
...
<?php /**PATH /var/www/html/CodeLouche/Site/AutomatisationInventaire/resources/views/localisationBatiment.blade.php ENDPATH**/ ?>