...
<head>
    ...
    <script src="<?php echo e(asset('js/produit.js')); ?>" defer></script>
    <script src="<?php echo e(asset('js/app.js')); ?>" defer></script>
    <script src="<?php echo e(asset('images/produits')); ?>" defer></script>
    ...
    <div>
        ...
        <div class="row mx-2">
            <div class="col-sm-4" style="margin: auto">
                <form action="<?php echo e(route('categorie.ajout')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="bouton"
                                        onclick="location='<?php echo e(route('ajout')); ?>'">Annuler</button>
            ...
            <div class="col-sm-4">
                <form action="<?php echo e(route('fournisseur.ajout')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <button name="addFournisseur" onclick=showModal2() class="form-label">Ajouter un
                        Fournisseur</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="bouton" onclick="location='<?php echo e(route('ajout')); ?>'">Annuler</button>
                                    <button class="bouton" type="submit">Ajouter</button>
                                </div>
                            </div>
                        </div>
        ...
        <form method="post" action="<?php echo e(url('update/'.$produits->id)); ?>"
            ...
            <div class="row mx-2">
                ...
                -webkit-transform: translateX(-50%)" required>
                    <option value=""><?php echo e($produits->categorie_id); ?></option>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat1 => $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody>
                        <div>
                            <tr>
                                ...
                                <td style="width: 700px">
                                    <input id="nom" type="text" class="form-control" name="nom" required value="<?php echo e($produits->nom); ?>"
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input id="ref" type="text" class="form-control" name="ref" value="<?php echo e($produits->ref); ?>" >
                                    <!-- Error -->
                                    <?php if($errors->has('ref')): ?>
                                        <div class="error">
                                            <?php echo e($errors->first('ref')); ?>
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input id="quantite" type="text" class="form-control" name="quantite" required  value="<?php echo e($produits->quantite); ?>"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="seuilAlerte" type="text" class="form-control" name="seuilAlerte"
                                        required autocomplete="seuilAlerte" autofocus placeholder="*Obligatoire"  value="<?php echo e($produits->seuilAlerte); ?>"
                                        pattern="[0-9]{1,}">
                                    <!-- Error -->
                                    <?php if($errors->has('seuilAlerte')): ?>
                                        <div class="error">
                                            <?php echo e($errors->first('seuilAlerte')); ?>
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input id="numBon" type="text" class="form-control" name="numBon" value="<?php echo e($produits->numBon); ?>">
                                    <!-- Error -->
                                    <?php if($errors->has('numBon')): ?>
                                        <div class="error">
                                            <?php echo e($errors->first('numBon')); ?>
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input id="description" type="text" class="form-control" name="description"  value="<?php echo e($produits->description); ?>">
                                    <!-- Error -->
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="cheminImage" id="cheminImage" class="form-control" value="<?php echo e($produits->cheminImage); ?>"/>
                                    <input type="file" name="cheminImage" id="cheminImage" class="form-control"/>
                                    <!-- Error -->
                                    <?php if($errors->has('cheminImage')): ?>
                                        <div class="error">
                                            <?php echo e($errors->first('cheminImage')); ?>
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input type="button" name="Voir" id="" class="form-control-lg" value="Voir"/>
                                    <input type="button" name="modifierLocalisation" id="" class="form-control-lg" value="Modifier" href="<?php echo e(url('localisationBatiment/${id}')); ?>" />
                                    <!-- Error -->
                                    <?php if($errors->has('cheminImage')): ?>
                                        <div class="error">
                                            <?php echo e($errors->first('cheminImage')); ?>
            ...
            <br>
            <div class="row">
                <button class="bouton"  style="margin: auto auto" onclick="location='<?php echo e(route('gestionStocks')); ?>'">Annuler</button>
                <button type="submit" name="send" style="margin: auto auto">Enregistrer</button>
            </div>
        </form>
    ...
    <script>
        ...
        $('#niveau').change(function() {
            ...
            if (niveau == 2) { // ----------------------- Si niveau = 2, afficher seulement la categorie
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(url('getSub3')); ?>?niveau=" + niveau,
                    success: function(res) {
            ...
            if (niveau ==
                ...
                $('#addCategorie').change(function() {
                    ...
                    if (addCatID) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "<?php echo e(url('getSub4')); ?>?id=" + addCatID,
                            success: function(res) {
...
<?php /**PATH /var/www/html/CodeLouche/Site/AutomatisationInventaire/resources/views/modifierProduit/index.blade.php ENDPATH**/ ?>