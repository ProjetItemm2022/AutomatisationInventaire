            ...
            $('#dataTable').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'id',
                        render: function(data, type, row, meta) {
                            return `<a class="bouton" style="margin:auto auto; text-align: center; display:block;  text-decoration: none ; color:black;" href="<?php echo e(url('editUser/${data}')); ?>">Modifier</a>`
                        }
                    },
                    {
                        data: 'nom',
...
<?php /**PATH /var/www/html/AutomatisationInventaire/resources/views//user.blade.php ENDPATH**/ ?>