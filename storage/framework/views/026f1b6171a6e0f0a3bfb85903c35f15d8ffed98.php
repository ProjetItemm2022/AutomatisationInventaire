            ...
            $('#dataTable').dataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'id',
                        render: function(data, type, row, meta) {
                            return `<a class="bouton" style="margin:auto auto; text-align: center; display:block;  text-decoration: none ; color:black;" href="<?php echo e(url('edit/${data}')); ?>">Modifier</a>`
                        }
                    },
                    {
                        data: 'nom',
...
<body class="color">
    ...
    <div>
        <div>
            ...
            <div>
                <br><br>
                <input type="button" onclick="location='<?php echo e(route('ajout')); ?>'" class="bouton" value="Ajouter"
          ...
          $('#subcat2').change(function() {
            $("#dataTable").empty();
              ...
              if (subCatID2) {
                  ...
                  $.ajax({
                      type: "GET",
                      url: "<?php echo e(url('getSub5')); ?>?id=" + subCatID2,
                      success: function(res) {
...
<?php /**PATH /var/www/html/AutomatisationInventaire/resources/views/gestionStocks/index.blade.php ENDPATH**/ ?>