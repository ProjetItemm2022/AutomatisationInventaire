...
<head>
    ...
    <title>delimitation des zones</title>
    ...
    <div id="app" class="">
        <nav class="flex header" style="margin-bottom: 2.5em">
            <img width="260" class=""
                ...
                <h2>Délimitation des zones pour une salle du batiment <?php echo e($nomBatiment); ?></h2>
        ...
        <div class="container">
            <h3>Cliquez  définir des zones</h3>
            <div class="control  row">
                <button id="draw" class="btn btn-primary toggle-label">Dessiner une zone pour la salle <span id="nomSalleCourante"></span></button>
                <button id="supprimer" class="btn btn-danger toggle-label">Effacer le dessin d'une zone</button>
                <button id="annuler" class="btn btn-danger toggle-label">Annuler</button>
                <button class="enregistrer toggle-label" onclick="location.replace('<?php echo e(route('assign.zone')); ?>');">Retour</button>
<!--                <button id="tst" class="btn btn-danger toggle-label">afficher salles</button>-->
    ...
    <input type="hidden" id="idSalleCourante" value="-1" />

<!-- Modal liste zone -->
<div class="modal" id="modalListeZone" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Liste des zones</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form>
              <select id="listeZones"></select>
          </form>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="$('#modalListeZone').toggle();">Fermer</button>
          <button type="button" class="btn btn-primary" id="BtnSupprimer">Supprimer</button>
        </div>
      </div>
    </div>
  </div>
...
var y = 0;
    ...
    <script src="<?php echo e(asset('js/assignationZoneZoom.js')); ?>" defer type="module"></script>
</body>

</html>
<?php /**PATH /var/www/html/AutomatisationInventaire/resources/views/assignation/zonezoom.blade.php ENDPATH**/ ?>