...
<head>
    ...
    <script src="<?php echo e(asset('js/qrCode.js')); ?>" defer></script>
...
<script>
    ...
    $(function() {
        $('#dataTableQrCode').dataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: '<?php echo e(url('ProduitData')); ?>',
            columns: [{
                    data: 'id',
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-vertical" method="POST" enctype="multipart/form-data"
                        action="<?php echo e(route('downloadQrCode')); ?>">
...
<?php /**PATH /var/www/html/CodeLouche/Site/AutomatisationInventaire/resources/views/QrCode/GenererQrCodeBoite.blade.php ENDPATH**/ ?>