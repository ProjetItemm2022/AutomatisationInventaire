...
<body class="colorfond">
    ...
    <div>
        <div name="menu" id="form1">
            ...
            <br><br><br>
            <div class="row">
                <button type="button" style="margin-left: auto" onclick="location='<?php echo e(route('assign.name')); ?>'">
                    <span>Nommer les batiments</span>
                </button>
                <br><br>
                <span style="margin-right: 75px"></span>
                <button type="button" style="margin-right: auto" onclick="location='<?php echo e(route('assign.batiment')); ?>'">
                    <span>Délimiter les batiments</span>
                </button>
            </div>
            <br><br>
            <div class="row">
                <button style="margin-left: auto" onclick="location='<?php echo e(route('assign.salle')); ?>'">
                ...
                <button style="margin-right: auto" onclick="location='<?php echo e(route('assign.zone')); ?>'">
                    <span>Délimiter les zones</span>
                </button>
            </div>
            <br><br>
            <div class="row">
                <button style="margin-left: auto" onclick="location='<?php echo e(route('index')); ?>'">
...
<?php /**PATH /var/www/html/CodeLouche/Site/AutomatisationInventaire/resources/views/assignation/menu.blade.php ENDPATH**/ ?>