...
<body id="body">
    ...
    <form method="post" action="<?php echo e(action('App\Http\Controllers\LocalisationController@creerBoite')); ?>"
        enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <h1 class="titre">Création de boites</h1>
        <div style="margin-left: 2%; margin-right: 2%;">
            ...
            <div class="dropdown">
                ...
                <select name="batiment" id="batiment_id" class="btn btn-secondary dropdown-toggle">
                    ...
                    <?php $__currentLoopData = $batiments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($bat->id); ?>" title="<?php echo e($bat->cheminImage); ?>"><?php echo e($bat->nom); ?></option>
            ...
            <div>
                <b><label for="Quantité">Quantité :     </label></b>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#produit_id').change(function() {
                var idProd = $('#produit_id').val();
                console.log(idProd);

                if(idProd){
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(url('getQuantite')); ?>?id=" + idProd,
                        success: function(res) {
                        console.log(res);
                        var Quant =res;
            ...
            $('#batiment_id').change(function() {
                ...
                if (batID!="-1") {
                    ...
                    console.log(srcImg);
                    $("#imageSelection").attr('src',"<?php echo e(url('')); ?>"+srcImg);
...
<?php /**PATH /var/www/html/AutomatisationInventaire/resources/views/ajoutBoites.blade.php ENDPATH**/ ?>