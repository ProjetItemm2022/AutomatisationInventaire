...
<body id="body">
    ...
    <form method="post" action="<?php echo e(action('App\Http\Controllers\LocalisationController@creerBoite')); ?>"
        ...
        <?php echo csrf_field(); ?>
        <h1 class="titre">Localisation du materiel</h1>
...
<?php /**PATH /var/www/html/CodeLouche/Site/AutomatisationInventaire/resources/views/ajoutBoites.blade.php ENDPATH**/ ?>