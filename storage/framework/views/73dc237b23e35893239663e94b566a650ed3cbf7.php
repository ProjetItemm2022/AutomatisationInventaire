    ...
    <div id="app" class="">
        <nav class="flex header" style="margin-bottom: 2.5em">
            <img width="260" class=""
                ...
                <h2>Délimitation des batiments</h2>
        ...
        <div class="container">
            ...
            <div class="control  row">
                ...
                <button id="supprimer" class="btn btn-danger toggle-label">Effacer le dessin d'un batiment</button>
            <button class="enregistrer toggle-label" onclick="location.replace('<?php echo e(route('assignation')); ?>');">Retour</button>
...
<!--            </div>-->
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <label for="name-select"> <h2>Veuillez choisir le nom du batiment</h2></label>
                            <select id="select-batiment" class="form-select">
                             </select>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-primary" id="modalBtn">Valider</button>
                      <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="$('#modal').toggle();">Annuler</button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <script src="<?php echo e(asset('js/assignationBatiment.js')); ?>" defer type="module"></script>
</body>

</html>
<?php /**PATH /var/www/html/CodeLouche/Site/AutomatisationInventaire/resources/views/assignation/batiment.blade.php ENDPATH**/ ?>