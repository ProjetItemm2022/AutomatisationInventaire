            ...
            $('#dataTable').dataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'id',
                        render: function(data, type, row, meta) {
                            return `<a href="<?php echo e(url('edit/${data}')); ?>">Modifier</a>`
                        }
                    },
                    {
                        data: 'nom',
...
<?php /**PATH /var/www/html/CodeLouche/Site/AutomatisationInventaire/resources/views/gestionStocks/index.blade.php ENDPATH**/ ?>