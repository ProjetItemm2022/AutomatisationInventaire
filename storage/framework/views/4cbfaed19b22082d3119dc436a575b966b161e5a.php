...
<body>
    <div id="app" class="">
        <nav class="flex header" style="margin-bottom: 2.5em">
            <img width="260" class=""
                ...
                <h2>Délimitation des salles d'un batiment</h2>
        ...
        <div class="container">
            ...
            <br/><br/>
                ...
                <img src="./plan/0PlanGeneral.png" alt="plan" height="<?php echo e($size[1]); ?>" width="<?php echo e($size[0]); ?> usemap="#mapplan"/>
  ...
  <area shape="circle" coords="337,300,44" alt="Coffee" href="coffee.htm">
    ...
    <script src="<?php echo e(asset('js/assignationSalle.js')); ?>" defer type="module"></script>
</body>

</html>
<?php /**PATH /var/www/html/AutomatisationInventaire/resources/views/assignation/salle.blade.php ENDPATH**/ ?>