    ...
    else
    {
        ...
        var ProdId = $('#Prod :selected').val();
            ...
            var ligne = "<tr id='ligne"+ num +"'><td><input type='checkbox' name='select'></td><td>" + nom +"</td><td>" +
                reference + "</td><td><select id='fournisseur' name='fournisseur' class='btn btn-secondary dropdown-toggle' ><option value=''>Aucun</option><?php $__currentLoopData = $fournisseurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $four => $fournisseur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value='<?php echo e($four); ?>''> <?php echo e($fournisseur); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td><td><input type='number' id='quantite' name='quantite'  value='1' min='1' max='100' required></td></tr>";
...
<?php /**PATH /var/www/html/AutomatisationInventaire/resources/views/ticket.blade.php ENDPATH**/ ?>