...
<body class="color">
    ...
    <div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="bouton"
                                        onclick="location='{{ route('ajout') }}'">Annuler</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="bouton" onclick="location='{{ route('ajout') }}'">Annuler</button>
                                    <button class="bouton" type="submit">Ajouter</button>
                                </div>
                            </div>
                        </div>
        ...
        <form method="post" action="{{ url('update/'.$produits->id) }}"
            ...
            <div class="row mx-2">
                ...
                -webkit-transform: translateX(-50%)" required>
                    <option value="">{{ $produits->categorie_id }}</option>
                    ...
                    <tbody>
                        <div>
                            <tr>
                                ...
                                <td style="width: 700px">
                                    <input id="nom" type="text" class="form-control" name="nom" required value="{{ $produits->nom }}"
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input id="ref" type="text" class="form-control" name="ref" value="{{ $produits->ref }}" >
                                    <!-- Error -->
                                    @if ($errors->has('ref'))
                                        <div class="error">
                                            {{ $errors->first('ref') }}
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input id="quantite" type="text" class="form-control" name="quantite" required  value="{{ $produits->quantite }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="seuilAlerte" type="text" class="form-control" name="seuilAlerte"
                                        required autocomplete="seuilAlerte" autofocus placeholder="*Obligatoire"  value="{{ $produits->seuilAlerte }}"
                                        pattern="[0-9]{1,}">
                                    <!-- Error -->
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input id="numBon" type="text" class="form-control" name="numBon" value="{{ $produits->numBon }}">
                                    <!-- Error -->
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input id="description" type="text" class="form-control" name="description"  value="{{ $produits->description }}">
                                    <!-- Error -->
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="cheminImage" id="cheminImage" class="form-control" value="{{ $produits->cheminImage }}"/>
                        ...
                        <div>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="button" name="modifierLocalisation" id="" class="form-control-lg" value="Modifier" href="{{ url('localisationBatiment/${id}') }}" />
                                    <!-- Error -->
                                    @if ($errors->has('cheminImage'))
                                        <div class="error">
                                            {{ $errors->first('cheminImage') }}
            ...
            <br>
            <div class="row">
                <button class="bouton"  style="margin: auto auto" onclick="location='{{ route('gestionStocks') }}'">Annuler</button>
