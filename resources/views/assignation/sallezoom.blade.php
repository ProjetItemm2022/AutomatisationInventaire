...
<head>
    ...
    <title>Délimitation des salles</title>
    ...
    <div id="app" class="">
        <nav class="flex header" style="margin-bottom: 2.5em">
            <img width="260" class=""
                ...
                <h2>Délimitation des salles pour le batiment {{ $nomBatiment }}</h2>
        ...
        <div class="container">
            ...
            <div class="control  row">
                ...
                <button class="enregistrer toggle-label" onclick="location.replace('{{ route('assign.salle') }}');">Retour</button>
...
var y = 0;
    ...
    <script src="{{ asset('js/assignationSalleZoom.js') }}" defer type="module"></script>
</body>
