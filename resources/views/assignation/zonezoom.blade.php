    ...
    <div id="app" class="">
        <nav class="flex header" style="margin-bottom: 2.5em">
            <img width="260" class=""
                ...
                <h2>Délimitation des zones pour une salle du batiment {{ $nomBatiment }}</h2>
        ...
        <div class="container">
            ...
            <div class="control  row">
                ...
                <button class="enregistrer toggle-label" onclick="location.replace('{{ route('assign.zone') }}');">Retour</button>
<!--                <button id="tst" class="btn btn-danger toggle-label">afficher salles</button>-->
    ...
    <input type="hidden" id="idBat" value="{{ $id }}" />
...
var y = 0;
    ...
    <script src="{{ asset('js/assignationZoneZoom.js') }}" defer type="module"></script>
</body>
