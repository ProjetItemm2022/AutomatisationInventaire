...
<body class="colorfond">
    ...
    <div name="menu" id="form1 ">
        @if ($Idprivilege = 'Administateur')
    <br>
    <br>
    <br>
            <div class="row">
                <button style="margin-left: auto" onclick="location='{{ route('gestionStocks') }}'">
                    <span>Gérer les Stocks</span>
                </button>
                <br><br>
                <span style="margin-right: 75px"></span>
                <button onclick="location='{{ route('user') }}'" style="margin-right: auto">
            ...
            <div class="row">
                ...
                <button onclick="location='{{ route('GestionBoites') }}'" style="margin-left: auto">
                    <span>Gestion des boites</span>
                </button>
                <br><br>
                <span style="margin-right: 300px"></span>
                <button onclick="location='{{ route('GenererQrCodeBoite') }}'" style="margin-right: auto">
                    <span>Gestion des QrCodes</span>
                </button>
            </div>
            <br><br>
            <div class="row">
                <button style="margin-left: auto" onclick="location='{{ route('assignation') }}'">
                ...
                <span style="margin-right: 150px; margin-left:150px" id="imgItemm">
                    ...
                    <button type="button" style="margin-right: auto" onclick="location='{{ route('consult') }}'">
            ...
            <br><br>
            <div class="row">
                <button style="margin-left: auto" onclick="location='{{ route('ticket') }}'">
            ...
            <br><br>
            <div class="row">
                <button onclick="location='{{ route('historique') }}'" style="margin-left: auto">
                    <span>Historique</span>
                </button>
                <br><br>
                <span style="margin-right: 75px"></span>
                <button style="margin-right: auto" id="buttonLogout" href="href=" {{ route('logout') }} onclick="event.preventDefault();
